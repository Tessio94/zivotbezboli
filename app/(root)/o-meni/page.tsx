  ...
  return (
    <>
      ...
      <section className="bg-theme1/10 px-6 py-16 sm:px-10 sm:py-20 lg:px-18 lg:py-26">
        <div className="flex flex-col gap-10 xl:flex-row">
          <div className="flex flex-col gap-4 xl:py-20">
            <h2 className="text-theme1 mb-11 text-5xl font-semibold">O meni</h2>
            <p className="text-theme4 text-2xl">Kako je sve počelo..?</p>
          ...
          <div className="h-fit shrink-0 overflow-hidden max-xl:flex max-xl:gap-10">
            <Image
      ...
      <section className="px-6 py-16 sm:px-10 sm:py-20 lg:px-18 lg:py-26">
        <h2 className="text-theme1 mb-15 text-5xl font-semibold">Školovanje</h2>
