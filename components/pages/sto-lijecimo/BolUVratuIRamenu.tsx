...
const BolUVratuIRamenu = () => {
  return (
    <>
      <section>
        <div className="flex flex-col md:flex-row">
          <div className="relative z-10 bg-[url(/zivotbezboli-background-nostroke-1920.jpg)] max-md:order-1 max-md:order-2 md:md:w-1/2">
      ...
      <section className="bg-theme1/10">
        <div className="flex flex-col xl:flex-row">
          <div className="flex flex-col gap-10 px-6 py-16 sm:px-10 sm:py-20 lg:px-18 lg:py-26 xl:w-1/2 xl:gap-3.5 2xl:gap-10">
...
export default BolUVratuIRamenu;
