...
const Header = () => {
  ...
  return (
    <header className="absolute right-0 left-0 z-100 flex max-w-screen flex-row items-center justify-between bg-transparent px-6 py-3 sm:px-10 lg:px-18">
      ...
      <nav
        className={cn(
          "xxsm:w-[260px] border-theme3 bg-theme4 fixed top-0 bottom-0 left-0 z-9999 flex w-[300px] flex-col justify-between border-r-2 bg-[url(/logo_transparent.png)] bg-contain bg-repeat py-12 shadow-[inset_-50px_0_50px_-50px_var(--theme3)] transition-all duration-300 sm:w-[330px] lg:hidden",
      ...
      >
        ...
        <ul className="flex flex-col gap-6 text-2xl">
          ...
          <li>
            <div className="text-md group relative flex w-full cursor-pointer items-center gap-2 px-3 py-1 text-2xl font-bold tracking-widest text-slate-100 capitalize">
              Usluge
              <BiChevronDown className="text-3xl transition-all duration-300 group-hover:rotate-x-180" />
              <div className="invisible absolute top-[130%] max-h-0 opacity-0 transition-all duration-300 group-hover:visible group-hover:max-h-250 group-hover:opacity-100">
                <ul className="flex flex-col">
