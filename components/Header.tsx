		...
		<header className="z-100 flex max-w-screen flex-row items-center justify-between bg-transparent px-8 py-3 lg:px-12 xl:px-30 absolute left-0 right-0">
			...
			<nav className="hidden lg:block">
				<ul className="flex items-center lg:gap-8 xl:gap-14 2xl:gap-22">
					...
					<li>
						<div className="relative  cursor-pointer text-md font-semibold text-slate-100 flex gap-2 items-center group">
							USLUGE
								...
								<ul className="flex flex-col">
									<li>
										<Link
											...
											className="px-3 py-2 bg-slate-100 text-theme4 text-nowrap block hover:text-slate-100 hover:bg-theme4 transition-all duration-300 rounded-t-xl"
										>
											Kronična bol
										</Link>
									</li>
									<li>
										<Link
											...
											className="px-3 py-2 bg-slate-100 text-theme4 text-nowrap block hover:text-slate-100 hover:bg-theme4 transition-all duration-300 border-t border-theme4"
										>
											Bol u vratu
										</Link>
									</li>
									...
									<li>
										<Link
											...
											className="px-3 py-2 bg-slate-100 text-theme4 text-nowrap block hover:text-slate-100 hover:bg-theme4 transition-all duration-300 border-t border-theme4 rounded-b-xl"
										>
											Ostale tegobe
										</Link>
									</li>
			...
			<div>
				<Link
					href="/rezervacija"
					className="text-md font-semibold text-slate-100 uppercase bg-theme1 px-5 py-2 rounded-4xl"
				>
					Rezervacija
				</Link>
			</div>
