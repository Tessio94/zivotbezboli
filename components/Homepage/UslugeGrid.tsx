		...
		<section className="">
			<div className="px-30 py-20">
				...
				<div className="grid grid-cols-5 items-stretch gap-10">
					<div className="p-8 rounded-2xl flex items-center flex-col gap-10  bg-theme1/20 border-2 border-theme1 hover:bg-theme1/30 transition-all duration-300 justify-between">
						<Image
